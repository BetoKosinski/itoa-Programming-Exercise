...
- Dynamic array with doubling strategy for digit storage.
- Do-while loop instead of while ensures all remainders are captured.
- Returns nullptr for invalid input.
